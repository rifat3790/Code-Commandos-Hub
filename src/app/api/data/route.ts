...
export async function GET() {
  try {
    ...
    if (!settings) {
      const defaultMenus = ['Home', 'Workspace', 'Message Helper', 'Templates', 'Schema Builder', 'Audit Suite', 'Projects', 'Mockup Studio', 'AI Assistant', 'Team Notes', 'Downloads', 'Member Profile', 'Settings'];
