...
export default function TimelineDashboard() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {deletingId && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-red-500/30 rounded-2xl w-full max-w-md shadow-2xl p-6 space-y-5 text-center relative">
            <button
            ...
            <div className="w-14 h-14 bg-red-500/20 border border-red-500/40 text-red-400 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-red-500/10">
              <Trash2 className="w-7 h-7" />
            </div>

            <div className="space-y-1">
              <h3 className="text-lg font-bold text-white uppercase tracking-wider">Confirm Delete Timeline</h3>
            ...
            <div className="flex items-center justify-center gap-3 pt-2">
              ...
              <button
                ...
                disabled={isDeleting}
                className="px-6 py-2.5 bg-red-600 hover:bg-red-500 text-white text-xs font-bold uppercase tracking-wider rounded-xl shadow-lg shadow-red-600/30 transition-all cursor-pointer disabled:opacity-50"
              >
